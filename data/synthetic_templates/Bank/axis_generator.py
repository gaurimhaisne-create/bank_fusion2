...
class BankStatementGenerator:
    ...
    def draw_bank_logo(self, c):
        ...
        c.drawCentredString(self.page_width / 2, y, "AXIS BANK")
        y -= 18
        c.setFont("Helvetica-Oblique", 10)
        c.drawCentredString(self.page_width / 2, y, "Badhti Ka Naam Zindagi")
    ...
    def draw_transaction_table_header(self, c, y):
        ...
        # Adjusted column positions with proper spacing
        col_positions = {
    ...
    def draw_transaction(self, c, y, txn, col_positions, is_brought_forward=False, balance_only=False):
        ...
        # Balance - right aligned with Cr suffix
        c.drawRightString(col_positions['balance'] + 50, y, f"{txn['balance']:,.2f}Cr")
    ...
    def draw_footer(self, c, y, total_debit, total_credit, debit_count, credit_count):
        ...
        c.drawString(self.margin_left, y, "Toll Free No. 1800-419-5959")
...
def main():
    ...
    # CORRECTED: Go to the PARENT raw_pdfs folder (not inside data/synthetic_templates)
    # From: data/synthetic_templates/Bank/
    # Need: data/raw_pdfs/Axis/
    # output_dir = "../raw_pdfs/Axis"
    output_dir = "../../../data/raw_pdfs/Axis"

    os.makedirs(output_dir, exist_ok=True)
    
    print("=" * 70)
    print("Axis Bank Statement Generator")
    print("=" * 70)
